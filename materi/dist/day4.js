...
const fruits1 = ["apple", "banana", "orange", "manggo", "lemon"];
...
console.log(result2);
// FOREACH -> pr
const fruits5 = ["manggo", "apple", "banana", "orange", "lemon"];
let container = "";
...
const fruit6 = ["manggo", "apple", "banana", "orange", "lemon"];
